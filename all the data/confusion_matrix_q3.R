...
rpi <- read.csv('possesion_event_q3_rpi.csv', fileEncoding="UTF-8-BOM")
rpia <- rpi$RPIA
rpib <- rpi$RPIB
oppo <- read.csv('possesion_event_q3_oppo.csv', fileEncoding="UTF-8-BOM")
oppoa <- oppo$OPPOA
oppob <- oppo$OPPOB
shot_for <- read.csv('possesion_event_q3_for.csv', fileEncoding="UTF-8-BOM")
shot_for <- shot_for$Shot_for
shot_against <- read.csv('possesion_event_q3_against.csv', fileEncoding="UTF-8-BOM")
